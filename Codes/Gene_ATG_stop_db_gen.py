...
# This script looks for ATG starting codon and extends the potential ORF until it
# encounters an STOP codon


# Run: python ORFinder.py <input genome in FASTA file> 
# <output files>: (stored at the same folder) genome name_ORFs_forward/reversed.txt
# the output files contain the coordinates where and ORF was found and repeats the same operation
# by revering the sequence.
